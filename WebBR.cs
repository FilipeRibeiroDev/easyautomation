...
namespace EasyAutomationFramework
{
    public static class WebBR
    {
        ...
        /// <returns></returns>
        public static IWebDriver IniciarNavegador(TypeDriver typeDriver = TypeDriver.GoogleChorme)
        {
            try
            {
                switch (typeDriver)
        ...
        public static void Clique(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
        ...
        /// <param name="timeout"></param>
        /// <returns></returns>
        public static string ObterValor(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// <param name="timeout"></param>
        public static void AtribuirValor(TypeElement typeElement, string element, string value, int timeout = 3)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// <param name="timeout"></param>
        /// <returns></returns>
        public static DataTable ObterDadosDaTabela(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// <param name="value"></param>
        /// <param name="timeout"></param>
        public static void SelecionarValor(TypeElement typeElement, TypeSelect typeSelect, string element, string value, int timeout = 3)
        {
            try
            {
        ...
        /// <param name="timeout"></param>
        /// <returns></returns>
        public static Image ObterImagemDaWeb(TypeElement typeElement, string element, string nameImage, int timeout = 3)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string ResolverCaptcha(Pix imagePix)
        {
            string res = "";
            try
            {
        ...
        /// <param name="element"></param>
        /// <param name="timeout"></param>
        public static void AcessarPopUpAoClicarElemento(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// <param name="element"></param>
        /// <param name="timeout"></param>
        public static void AcessarFrame(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// </summary>
        /// <param name="timeout"></param>
        public static void AguardarCarregamento(int timeout = 60)
        {
            try
            {
        ...
        /// <param name="element"></param>
        /// <param name="timeout"></param>
        public static void AguardaElemento(TypeElement typeElement, string element, int timeout = 3)
        {
            try
            {
